...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::version::manage::get_version_effective_dir,
            commands::version::manage::get_version_personalization,
            commands::version::manage::update_version_personalization,
            commands::version::manage::export_launch_script,
