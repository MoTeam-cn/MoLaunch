...
pub(super) const PROTOCOL: &str = "molaunch";
...
/// 获取当前运行 exe 的完整路径
pub(super) fn current_exe_path() -> Option<String> {
    std::env::current_exe()
        .ok()
...
pub fn register() -> Result<(), String> {
    ...
    #[cfg(windows)]
    {
        super::windows::register_windows()
    }
    #[cfg(target_os = "linux")]
    {
        super::linux::register_linux()
    }
...
pub fn unregister() -> Result<(), String> {
    ...
    #[cfg(windows)]
    {
        super::windows::unregister_windows()
    }
    #[cfg(target_os = "linux")]
    {
        super::linux::unregister_linux()
    }
    #[cfg(not(any(windows, target_os = "linux")))]
    {
...
fn registered_exe() -> Option<String> {
    #[cfg(windows)]
    {
        super::windows::registered_exe_windows()
    }
    #[cfg(target_os = "linux")]
    {
        super::linux::registered_exe_linux()
    }
    #[cfg(not(any(windows, target_os = "linux")))]
    {
        None
