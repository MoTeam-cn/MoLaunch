...
use super::types::{InstallModpackRequest, InstallModpackResult, ModpackFormat};
...
pub async fn install_modpack(
    ...
    match info.format {
        ...
        ModpackFormat::Modrinth => {
            ...
            super::modrinth::install_mr_files(&state, &index.files, &instance_dir, max_threads)
                .await?;
        }
    }
    {
