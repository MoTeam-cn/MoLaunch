//! 清理扫描实现：枚举三类可清理目录并累计大小
//! 根目录固定子目录 / 版本目录下子目录 / 各版本 natives 目录。

use std::path::{Path, PathBuf};

use super::super::types::{CleanupItem, CleanupScanResult};
use super::fs;
...
pub(super) fn build_allowed_parents(game_dir: &Path) -> Vec<PathBuf> {
