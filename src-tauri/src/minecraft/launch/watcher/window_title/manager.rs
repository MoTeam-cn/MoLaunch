//! 窗口标题落地管理：轮询找到窗口并改写标题（平台分发）

use std::time::Duration;

#[cfg(target_os = "linux")]
use super::linux::{is_window_visible, set_window_title};
#[cfg(target_os = "macos")]
use super::macos::{is_window_visible, set_window_title};
#[cfg(windows)]
use super::windows::{is_window_visible, set_window_title};
